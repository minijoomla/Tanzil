...
<div class="tanzil-search<?php echo $moduleclass_sfx; ?>">
	<ul class="nav nav-tabs">
		<li class="active"><a href="#search-quran-tab" data-toggle="tab"><?php echo JText::_('MOD_TANZIL_SEARCH_QURAN'); ?></a></li>
	...
	<div class="tab-content">
		<div id="search-quran-tab" class="tab-pane fade in active">
