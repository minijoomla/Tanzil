...
<div class="text-right">
	<button class="control-group hasTooltip" id="soundOptions" title="<?php echo JText::_('MOD_TANZIL_RECITATION_OPTIONS'); ?>"><i class="icon-wrench"></i></button>
	<fieldset class="sound-options form-horizontal">
