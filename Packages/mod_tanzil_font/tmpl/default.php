...
<div class="tanzil-font<?php echo $moduleclass_sfx; ?>">
	<form method="post" action="javascript:updateFontSettings();" class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls span9">
				<select class="span12" id="fontMenu" name="font" onchange="updateFont();">
					<option value="def"><?php echo JText::_('MOD_TANZIL_FONT_DEFAULT'); ?></option>
					<option value="custom"><?php echo JText::_('MOD_TANZIL_FONT_CUSTOM'); ?></option>
				</select>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<label class="checkbox" for="textJustify">
				...
				<?php echo JText::_('MOD_TANZIL_FONT_ALIGN_TEXT'); ?>
			</label>
		</div>
	</form>
