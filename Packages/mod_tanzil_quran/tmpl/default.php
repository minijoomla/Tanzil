...
<div class="tanzil-quran<?php echo $moduleclass_sfx; ?>">
	<form method="post" action="javascript:updateQuranSettings();" class="form-horizontal">
		<div class="control-group">
			<label class="control-label span3" for="typeMenu">
				<?php echo JText::_('MOD_TANZIL_QURAN_TEXT'); ?>: 
				<!-- Button to trigger Text Type modal --> 
				<a href="#textTypesModal" role="button" class="hasTooltip info-mark" data-toggle="modal" title="<?php echo JText::_('MOD_TANZIL_QURAN_TEXT_TYPES'); ?>">?</a>
			</label>
	...
	<div id="textTypesModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="textTypesModalLabel" aria-hidden="true">
		...
		<div class="modal-footer">
			<button type="button" class="btn" data-dismiss="modal" aria-hidden="true">
				<?php echo JText::_('MOD_TANZIL_QURAN_CLOSE'); ?>
			</button>
		</div>
	</div>
</div>
